...
- Any IDE of choice (Visual Studio Code, PhpStorm, etc.)
- XAMPP Control Panel
- Git SCM

> ⚠️***Disclaimer:** For the outsiders looking at this repository - yes, it is meant to be very simple and straightforward as the exam takers are only given around 3-4 hours to accomplish their respective examinations.*

Best of luck in your PSE! 🎉
